...
import { Github, Linkedin, Instagram, Mail, ArrowUp, MessageCircle, Check, Phone } from 'lucide-react';
...
export default function Footer() {
  ...
  return (
    <footer className="pt-8 pb-8 border-t border-white/10 mt-8">
      <div className="max-w-[1428px] mx-auto px-6 md:px-[122px] space-y-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-x-6 gap-y-10 md:gap-12">
          ...
          <div className="space-y-4 md:space-y-6">
            ...
            <div className="flex flex-col gap-2 md:gap-3 text-sm text-white/60">
              <Link href="/projects" className="hover:text-white transition-colors">All Work</Link>
          ...
          <div className="space-y-4 md:space-y-6">
            ...
            <div className="flex flex-col gap-2 md:gap-3 text-sm text-white/60">
              ...
              <button onClick={() => setIsEmailModalOpen(true)} className="hover:text-white transition-colors text-left">
                Email
              </button>
              <button onClick={() => setIsContactModalOpen(true)} className="hover:text-white transition-colors text-left">
                Contact
              </button>
            </div>
          </div>
