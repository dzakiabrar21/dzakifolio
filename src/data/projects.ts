export const projects = [
  ...
  /*{
    title: "Web Disnaker Job Portal",
    desc: "A digital selection and training management system for the Department of Manpower, transforming a static prototype into a functional full-stack application.",
    tags: ["React", "Vite", "Tailwind CSS", "Express.js"],
    accuracy: "Internship Project",
    category: "Web Development",
    popupDesc: "A Digital Selection & Training Management System for the Department of Manpower. This project transforms a static prototype into a functional full-stack application for public services. Built with a dynamic user interface, application routing system, backend structure for job vacancy management, and an admin dashboard featuring SVG-based data visualizations.",
    images: [
      "/images/projects/disnaker-1.png",
      "/images/projects/disnaker-2.png",
      "/images/projects/disnaker-3.png",
    ]
  },*/
  {
